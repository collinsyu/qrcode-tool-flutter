...
class GenDetail extends StatefulWidget {
  final int id;
  const GenDetail({super.key, required this.id});

  @override
  State<GenDetail> createState() => _GenDetailState();
}

class _GenDetailState extends State<GenDetail> with TickerProviderStateMixin {
  late int id;
  QrCodeItem? codeinfo;
  bool isShowQrcode = false;
  void queryDetail() async {
    QrCodeItem? _data = await QrcodeGenHistory.getQrCodeById(id);
    setState(() {
      codeinfo = _data;
    });
  }
            ...
            Padding(
              ...
              child: Column(
                ...
                //   qrcode
                  ...
                  codeinfo?.value != null?Visibility(
